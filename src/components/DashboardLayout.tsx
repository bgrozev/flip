// Based on @toolpad/core/DashboardLayout 0.13.0
'use client';
...
import { BrandingContext, NavigationContext, WindowContext } from '@toolpad/core/shared/context';
import { Account, type AccountProps } from '@toolpad/core/Account';
import { DashboardSidebarSubNavigation } from '@toolpad/core/DashboardLayout/DashboardSidebarSubNavigation';
import { ToolbarActions } from '@toolpad/core/DashboardLayout/ToolbarActions';
import { AppTitle, AppTitleProps } from '@toolpad/core/DashboardLayout/AppTitle';
import { getDrawerSxTransitionMixin, getDrawerWidthTransitionMixin } from '@toolpad/core/DashboardLayout/utils';
...
export interface DashboardLayoutSlots {
  ...
  sidebarContent?: React.JSXElementConstructor<{}>;
}
...
function DashboardLayout(props: DashboardLayoutProps) {
  ...
  const isDesktopNavigationExpanded = props.isNavigationExpanded;
  const setIsDesktopNavigationExpanded = props.setIsNavigationExpanded;
  const isMobileNavigationExpanded = props.isNavigationExpanded;
  const setIsMobileNavigationExpanded = props.setIsNavigationExpanded;
  ...
  const SidebarContentSlot = slots?.sidebarContent ?? null;
