...
export default function WindDirectionArrow({ direction, speed }) {
    ...
    return (
        ...
        >
            ...
            >
                <Navigation sx={{ fontSize: 80, color: arrowColor }} /> {/* Customizable arrow with color */}
            </div>
            ...
            >
                {`${Math.round(direction)}° @ ${Math.round(speed)} kts`} {/* Display direction and speed */}
            </div>
        </div>
    );
}
